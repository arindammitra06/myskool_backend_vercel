                        ...
                        sendSms('Declare Exams',
                          {
                            ...
                            parent_1: resultObj[i].user.parent[j].parent.displayName,
                            parent_1_phone: resultObj[i].user.parent[j].parent.mobile,
                            parent_2: resultObj[i].user.parent[j].parent.displayName,
                            parent_2_phone: resultObj[i].user.parent[j].parent.mobile,
